<script lang="ts">
	...
	import { ACCENT_COLORS, DEFAULT_ACCOUNT_COLOR, DEFAULT_ACCOUNT_TYPE, getCardStyleFromHex } from '$lib/accountColors';
...
<div class="px-8 pt-16 pb-12">
	<div class="mx-auto max-w-lg">
		<div class="mb-6 flex items-center gap-4">
			<a href="/accounts" aria-label="Back to accounts" class="text-dark/50 hover:text-dark transition-colors">
			...
			<h1 class="text-dark text-2xl font-bold">New Account</h1>
		</div>
		...
		<form id="new-account-form" onsubmit={handleSubmit} class="flex flex-col gap-6">
			...
			<!-- Starting balance -->
			<label class="flex flex-col gap-2">
				<span class="text-dark text-sm font-medium">Starting Balance</span>
				<input
					type="number"
					min="0"
					step="0.01"
